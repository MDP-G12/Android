...
//	    }
    ...
    public void robopos(View v)
    {
       ...
       // sendMessage("GRID");
        ...
        // Button pos = (Button) v;
        //pgv.setCoordinates(5,10);

        //startActivity(new Intent(getApplicationContext(),Coordinates.class));
	    ...
	    /*public void onBtnStart2Pressed(View view) {
	    	sendMessage("pstart:r");
	    ...
	    /*public void onBtnStop2Pressed(View view) {
